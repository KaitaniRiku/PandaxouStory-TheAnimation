...
/**
 * Nom de la class: AnimationController()
 *
...
namespace App\Controllers\Simple_controllers\Animation;

class AnimationController extends \Core\System\ControllersProviderSystem
{
    /**
    ...
    {
        $this->setPageView('animation.twig');
        $this->setPageInfos(array(
            'page_title' => 'Pandaxou - Story'
        ));
    }
